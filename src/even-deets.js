export const Events = [
  {
   ...
   sub2No:"9383480394",
    ...
    descr: " This event has two rounds first is preliminary round which is about 4-8 minutes act based on their own choice from that only best 5 qualify to the final. In that round only 3-5 minutes duration is allowed based on the situation given by us. The first prize is 2000. No costumes are allowed.",
  },
  {id: "pt02",
    name: "Best Choreo",
...
{id: "pt17",
   ...
   sub2No:"7994214972",
    poster:
      "https://firebasestorage.googleapis.com/v0/b/pratitya-6b78c.appspot.com/o/Event-posters%2FBA-min.jpg?alt=media&token=5bb0701f-84c7-47f6-b377-ec9ad93b70ac",
    descr: "event name - Arabian Pottery(pottery art competition) caption - pottery: where art meets clay prize - 1000    venue - tbd  time - tbd Rules: 1) All artwork shall be done and completed by the artist him/herself within the given time 2) All the items will be provided 3) Pot should not be broken",
},
